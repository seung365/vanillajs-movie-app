...
(0, _indexJsDefault.default)() //여기서 부터 App으로 거꾸로 올라가면서 흐름을 이해해라.
;
...
var _movie = require("../store/movie");
var _movieDefault = parcelHelpers.interopDefault(_movie);
class MoveListMore extends (0, _heropy.Component) {
    constructor(){
        super({
            tagName: "button"
        });
...
class Movie extends (0, _heropy.Component) {
    ...
    `;
      ...
      <div class="specs">
        ...
        }).join("")}  <!--join \u{D574}\u{C11C} \u{BB38}\u{C790} \u{B370}\u{C774}\u{D130}\u{B97C} -->
        </div>
        <div>
          <h3>Actors</h3>
          <p>${movie.Actors}</p>
